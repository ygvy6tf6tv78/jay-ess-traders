          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="text-base font-bold text-slate-800">Select Number to Call</div>
                <button
                  onClick={() => setCallDialogOpen(false)}
      ...
      <AnimatePresence>
        {whatsappDialogOpen && (
          <>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="text-base font-bold text-slate-800">Select Number for WhatsApp</div>
                <button
                  onClick={() => setWhatsappDialogOpen(false)}
                  className="p-2 rounded-full hover:bg-slate-100 transition-colors"
                  aria-label="Close"
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                {siteConfig.contact.phones.map((phoneItem, index) => {
                  const phone = typeof phoneItem === 'string' ? phoneItem : phoneItem.number
                  const label = typeof phoneItem === 'string' ? undefined : phoneItem.label
                  const displayName = label || formatPhone(phone)
                  ...
                  return (
                    ...
                    >
                      <motion.button
                        ...
                        className="w-16 h-16 rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center relative"
                        style={{
                      ...
                      <span className="text-sm font-medium text-slate-700 mt-2">{displayName}</span>
                    </motion.div>
                  )
                })}
              </div>
